...
class QuizInterface:
    def __init__(self, quiz_brain: QuizBrain):
        ...
        true_img = PhotoImage(file="day34_trivia_quiz_project/images/true.png")
        self.true_button = Button(image=true_img, highlightthickness=0, command=self.answer_true)
        self.true_button.grid(row=2, column=0)

        false_img = PhotoImage(file="day34_trivia_quiz_project/images/false.png")
